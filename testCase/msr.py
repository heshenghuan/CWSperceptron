...
if __name__ == '__main__':
    ...
    cws.setSavePath(r'./models/msr/')
    # cws.pretreatment(r'./icwb2-data/training/msr_training.utf8')
    ...
    # count = cws.makeLibSvmData(r'./training/msr/msr_train.dat', -1)
    # print 'generate', count, 'training data file.'
    # cws.saveModel()

    cws.loadCorpus(r'./icwb2-data/testing/msr_test.utf8')
    if cws.perceptron.loadModel(r'./models/msr/msr.mdl'):
        print "Segmentation..."
        cws.segmentation(r"msr_seg.utf8")
        print "Done!"
    del cws
