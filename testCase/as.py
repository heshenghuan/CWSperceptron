...
if __name__ == '__main__':
    ...
    cws.setSavePath(r'./models/as/')
    #cws.pretreatment(r'./icwb2-data/training/as_training.utf8')

    cws.loadModel()
    print u"corpus number:        ", cws.corpus_num
    print u"unigram number:       ", cws.unigram_feat_num
    print u"bigram number:        ", cws.bigram_feat_num
    print u"trigram numbre:       ", cws.trigram_feat_num
    ...
    #count = cws.makeLibSvmData(r'./training/as/as_train.dat', -1)
    #print 'generate', count, 'training data file.'
    #cws.saveModel()

    cws.loadCorpus(r'./icwb2-data/testing/as_test.utf8')
    if cws.perceptron.loadModel(r'./models/as/as.mdl'):
        print "Segmentation..."
        cws.segmentation(r"as_seg.utf8")
        print "Done!"
    del cws
