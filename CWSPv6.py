...
# -*- coding: utf-8 -*-
"""
Created on 14:06:27 2016-01-01
...
CHANGED = "Updated on 14:31 2016-01-01"
            ...
            for it in range(len(feat)):
                if it < 5:
                    ...
                    if self.dict_feat_id.has_key(feat[it]):
                        ...
                        key += self.unigram_feat_num * 5 + self.bigram_feat_num * 4 + self.trigram_feat_num + self.dict_feat_num * (it - 10)
                        featVec[key] = 1
                else:
                    key = feat[it]
